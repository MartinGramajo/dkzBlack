            ...
            <div className="container padding-titulo">
                <div className="d-none d-md-block">
                    ...
                    <h4 className="py-4 peso-regular">
                        En nuestra agencia, desarrollamos estrategias
                        personalizadas para tu empresa con creatividad y
                        compromiso a la hora de ejecutar proyectos digitales.
                        Basándonos en una marcada trayectoria a la hora de
                        generar contenidos, trabajamos para crear campañas y
                        acciones específicas a través de las plataformas y
                        canales de redes sociales, de acuerdo con la estrategia
                        global de la empresa.
                    </h4>
                    <h4 className="py-4 peso-regular">
                        Crear una estrategia de social media eficaz puede ayudar
                        a hacer crecer tu negocio y crear un compromiso con el
                        público.
                    </h4>
                </div>
                ...
                <div className="d-md-none d-block">
                    <div className="d-flex justify-content-evenly">
                        <h5 className="peso-bold color-naranja py-3">
                            ESTRATEGIA
                        </h5>
                        <h5 className="peso-bold color-naranja py-3">
                            CREATIVIDAD
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-8 contenido-centrado py-1">
                        <h4 className="peso-regular d-none d-md-block">
                            En DKZ creemos en la importancia de crear
                            estrategias de marketing digital personalizadas que
                            cuenten historias únicas que conecten con tu
                            audiencia y generen el impacto que buscas.
                        </h4>
