                        ...
                        <Card.Body className="d-flex align-items-start py-0 ps-0 pe-4">
                            <Card.Text className="">
                                <h4 className="peso-bold interlineado3">
                                    ...
                                    un posicionamiento de marca, conjugar las
                                    diferentes estrategias publicitarias que se
                                    hagan de manera digital, con estas acciones
                                    de publicidad offline tradicional.
                                </h4>
                            </Card.Text>
                        </Card.Body>
                    </Card>
                        ...
                        <Card.Body className="d-flex align-items-start py-0 pe-0 ps-4">
                            <Card.Text className="">
                                <h4 className="peso-regular interlineado3">
                                    Por medio de este proceso estratégico,
                                    buscamos  mejorar la capacidad de elección,
                                    simplificar los procesos de compra y
                    ...
                    <div className="mx-3">
                        ...
                        <div className="pt-4">
                            ...
                            <h6 className="pt-3 pb-4 mb-3 peso-regular interlineado">
                                ...
                                variabilidad de acuerdo a diferentes
                                presupuestos
                            </h6>
                        </div>
                            ...
                            <Card.Body className="d-flex align-items-start p-0">
                                <Card.Text className="">
                                    <h6 className="peso-bold interlineado">
                                        Es de vital importancia a la hora de
                                        hacer un posicionamiento de marca,
                                        conjugar las diferentes estrategias
                                        publicitarias que se hagan de manera
                                        digital, con estas acciones de
                            ...
                            <Card.Body className="d-flex align-items-start p-0">
                                <Card.Text className="">
                                    <h6 className="peso-regular interlineado">
                                        Por medio de este proceso estratégico,
                                        buscamos mejorar la capacidad de
                                        elección, simplificar los procesos de
                                        compra y estimular la innovación
                                        comercial.
                                    </h6>
                                </Card.Text>
                            </Card.Body>
