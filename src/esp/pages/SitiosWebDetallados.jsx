            ...
            {loading ? (
                ...
                <div className="container">
                    <div className="d-flex justify-content-center d-none d-md-block">
                        <h2 className="text-white peso-bold pt-4 px-4">
                            {titulo}
                        </h2>
                    </div>

                    <div className="d-flex justify-content-center d-block d-md-none">
                        <h3 className="text-white peso-bold pt-4  px-4">
                            {titulo}
                        </h3>
                    </div>
                    ...
                    <Swiper
                        navigation={
                            width <= 500 ? true : imagen5 !== "" ? true : false
                        }
                    ...
                    <div className="d-sm-flex d-block justify-content-center align-items-center mb-5">
                        ...
                        <div className="d-md-none d-block">
                            ...
                            <a
                                ...
                                rel="noreferrer"
                            >
                                <h4 className="color-naranja peso-bold py-4">
                                    Click Here!
                                </h4>
                            </a>
                        </div>
