            ...
            <div className="container">
                <div>
                    ...
                    <h2 className="peso-bold py-4 d-none d-md-block">
                        Si trabajás en el mundo de la revolución digital
                        simplemente crees que tenes algo que aportar a nuestro
                        equipo, déjanos tus datos. <br /> Gracias!{" "}
                    </h2>
                </div>
                <div>
                    ...
                    <h3 className="py-4 peso-regular d-block d-md-none mx-3 ">
                        <span className="peso-bold">
                            Si trabajás en el mundo de la revolución digital o{" "}
                            simplemente crees que tenes algo que aportar a
                            nuestro equipo, déjanos tus datos. <br /> Gracias!{" "}
                        </span>
                    </h3>
                </div>
                <div className="d-none d-md-block">
