      ...
      <div className="container padding-titulo">
        <div className="d-none d-md-block">
          ...
          <h4 className="py-4 peso-regular">
            ...
            professionals highly qualified professionals who are capable of
            executing and events according to the highest standards of
            organizational quality and style. standards of organizational
            quality and style.
          </h4>
          <h4 className="py-4 peso-regular">
            We make sure that every event we organize is a unique and
            unforgettable experience, with a special unique and unforgettable
            experience, with a special focus on attention to detail and customer
            attention to detail and customer satisfaction. In addition, we offer
            audiovisual coverage services so you can remember and share the
            highlights of your event. share the highlights of your event, trust
            us to take your event to the us to take your event to the next
            level!
          </h4>
          ...
          <div>
            ...
            <h4 className="peso-regular">
              ...
              the entire process the entire process, from planning and design to
              the execution and coordination of the to the execution and
              coordination of the event itself. This This means that DKZ takes
              care of all aspects, including venue selection venue selection,
              stage design, supplier contracting, catering, logistics catering,
              logistics, decoration, decoration, lighting, sound, security,
              security lighting, sound, security, among other aspects, leaving
              you worry free.
            </h4>
          </div>
        </div>
