...
export const SitiosWebDetalladosEN = () => {
  ...
  return (
    <div className="color-negro-fondo text-center">
      ...
      {loading ? (
        ...
        <div className="container">
          <div className="d-flex justify-content-center d-none d-md-block">
            <h2 className="text-white peso-bold pt-4 px-4">{tituloEN}</h2>
          </div>

          <div className="d-flex justify-content-center d-block d-md-none">
            <h3 className="text-white peso-bold pt-4  px-4">{tituloEN}</h3>
          </div>
          ...
          <div className="text-white peso-regular my-5 text-start wrap-pre d-none d-md-block ">
            <h5 className="peso-regular">{descripcionEN}</h5>
          </div>
          <div className="text-white peso-regular my-5 text-start wrap-pre d-md-none d-block ">
            <h6 className="peso-regular mx-3">{descripcionEN}</h6>
          </div>
      ...
      <div className="d-flex justify-content-center ">
        <Link
          className="text-decoration-none text-white d-none d-lg-block pt-0 pb-5"
          to="/web-sites"
        >
          <h3 className="peso-bold">{"< < Back To"}</h3>
        </Link>
        <Link
          className="text-decoration-none text-white d-lg-none d-block pt-0 pb-4"
          to="/web-sites"
        >
