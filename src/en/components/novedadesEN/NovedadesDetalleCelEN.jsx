    ...
    <div className="mt-0 container">
      {loading ? (
        ...
        <div className="mx-3 pb-5">
          <h6 className="text-white peso-bold mb-4">{seccionEN}</h6>

          <h3 className="text-white peso-bold">{titularEN}</h3>
          <h5 className="text-white mt-4 ">{subtituloEN}</h5>
          ...
          <h5 className="text-white  mt-4 wrap-pre">{descripcionEN}</h5>
          {tituloIntermedioEN === "" ? (
            ""
          ) : (
          ...
          <h5 className="text-white mt-4 wrap-pre">{descripcion2EN}</h5>
        </div>
      )}
...
export default NovedadesDetalleCelEN;
