...
export default function OtrosCasosEN({ trabajos, tipo }) {
  ...
  return (
    <div>
      <div className="container">
        <h2 className="peso-bold pt-5 d-none d-md-block">CASES</h2>
        <h3 className="mx-3 peso-bold pt-5 d-md-none d-block">CASES</h3>
      </div>
