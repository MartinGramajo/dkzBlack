...
import "./DondeEncontranosEN.css";

const DondeEncontrarnosEN = () => {
  return (
    <div className="container">
      <div id="NovedadesHome" className=" padding-titulo ">
        <div className="container">
          <LineaNaranja />
          <h2 className="color-blanco my-5 peso-bold d-none d-xl-block">
            WHERE TO FIND US?
          </h2>
          <h3 className="color-blanco my-5 peso-bold d-xl-none d-block">
            WHERE TO FIND US?
          </h3>
        </div>
...
export default DondeEncontrarnosEN;
